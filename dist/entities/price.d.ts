...
export declare class Price<TBase extends SuiCoin, TQuote extends SuiCoin> extends Fraction {
     ...
     */
    multiply<TOtherQuote extends SuiCoin>(other: Price<TQuote, TOtherQuote>): Price<TBase, TOtherQuote>;
    /**
