...
describe('Route', () => {
  const token0 = new SuiCoin('0x066b804a94649350140e4d85d9fc28bd7ae52981e71cc2a35b1e661bb095d129::faucet::t0', 18, 't0', 't0')
  const token1 = new SuiCoin('0x066b804a94649350140e4d85d9fc28bd7ae52981e71cc2a35b1e661bb095d129::faucet::t1', 18, 't1', 't1')
  const token2 = new SuiCoin('0x066b804a94649350140e4d85d9fc28bd7ae52981e71cc2a35b1e661bb095d129::faucet::t2', 18, 't2', 't2')
  const weth = new SuiCoin('0x066b804a94649350140e4d85d9fc28bd7ae52981e71cc2a35b1e661bb095d129::faucet::WETH9', 18, 'WETH9', 'WETH9')
